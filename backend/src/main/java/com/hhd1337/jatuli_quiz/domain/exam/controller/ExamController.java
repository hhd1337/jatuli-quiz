...
public class ExamController {
    ...
    @Operation(
            summary = "시험 문제 출제",
            description = """
                    사용자가 선택한 리프 폴더별 출제 문제 수를 기준으로 시험 문제를 생성합니다.
                    
                    각 폴더의 북마크된 문제 중 solvedCount가 낮은 문제를 우선 출제하며,
                    solvedCount가 같은 문제들은 무작위로 선택합니다.
                    
                    시험 진행 중 정답이 노출되지 않도록 문제 내용과 폴더 정보만 반환하고,
                    정답과 해설은 반환하지 않습니다.
                    
                    제한 시간은 출제된 문제 수 × 문제당 4분으로 계산합니다.
                    """
    )
